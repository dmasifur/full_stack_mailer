...
from server.api.dependencies import get_current_user, get_db
from server.core.config import settings
from server.core.rate_limit import limiter
from server.models.user import User
from server.schemas.user import UserResponse
from server.services.auth.jwt import create_access_token
from server.services.auth.microsoft_oauth import (
    MICROSOFT_TOKEN_URL,
    build_authorization_url,
)
from server.services.token_encryption import encrypt_token
