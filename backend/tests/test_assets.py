...
from app.api.assets import MAX_ASSET_BYTES, _sniff
from app.services.asset_storage import AssetStorageNotConfiguredError, upload_asset
...
def test_storage_refuses_to_upload_without_a_public_url(monkeypatch):
    ...
    """
    import app.services.asset_storage as asset_storage
